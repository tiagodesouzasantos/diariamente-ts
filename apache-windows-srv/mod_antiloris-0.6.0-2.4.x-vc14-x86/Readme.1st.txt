  ...
  Distribution File: mod_antiloris-0.6.0-2.4.x-vc14-x86.zip 
 ...
 NOTES:
  ...
  The module is built with Visual Studio® 2015 x86, be sure to install the 
  new Visual C++ 2015 x86 Redistributable Package, download from;
